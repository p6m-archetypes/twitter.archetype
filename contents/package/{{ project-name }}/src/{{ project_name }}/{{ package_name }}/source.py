...
class TwitterSource:
    def __init__(self, page_size, max_retries, twitter_token):
    ...
    def get_tweets_by_user_ids(self, user_id):
        """
        Method to input user_id and return the tweet information for the latest 100 results. Also added user_id field for which the data was returned for.
        returns a combination of tweets data and twitter_error. The twitter_error is 1 if the api response is not successful.
        """
        twitter_error = 0
